...
namespace {
  ...
  // In vehicle coordinates the cross-track error is the intercept at x = 0
  ...
  // transform global coordindates to local vehicle coordinates
    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Translate to car coordinate system then rotate to the car's orientation. 
